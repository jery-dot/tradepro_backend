...
@php
    $typeColor  = ['contractor'=>'#1B3D6F','subcontractor'=>'#F5874F','labour'=>'#27AE60'][$job->type] ?? '#64748B';
    $typeLabel  = ['contractor'=>'Contractor','subcontractor'=>'Sub-contractor','labour'=>'Labour'][$job->type] ?? $job->type;
    $typeBadge  = ['contractor'=>'bn','subcontractor'=>'bo','labour'=>'bg'][$job->type] ?? 'bgr';
...
<div class="g2" style="align-items:start">
    ...
    <div class="card">
        ...
        <div class="cb">
            ...
            <div class="dp-row"><span class="dpk">Pay Rate</span><span class="dpv" style="color:var(--navy);font-weight:700">${{ $job->pay_rate }}/hr</span></div>
            <div class="dp-row"><span class="dpk">Location</span><span class="dpv">{{ $job->location }}</span></div>
            <div class="dp-row"><span class="dpk">Start Date</span><span class="dpv">{{ \Carbon\Carbon::parse($job->start_date)->format('d M Y') }}</span></div>
            <div class="dp-row"><span class="dpk">Duration</span><span class="dpv">{{ $job->duration }} {{ $job->duration_unit }}</span></div>
